...
<body>
    ...
    <?php include ('partials/header-nav.php'); ?> <div class="divider"></div>
    <form role="search">
    ...
    <ul class="nav menu">
        <li><a href="main.php"><em class="fa fa-home">&nbsp;</em> Pagina Pricipal</a></li>
        ...
        <li class="active"><a href="panels.php"><em class="fa fa-history">&nbsp;</em> Historial</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div>
           <button type="submit" name="historial" class="btn btn-primary">Mostrar Historial</button>
        </div>
    </div>
    <!--/.main-->
